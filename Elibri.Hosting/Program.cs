...
namespace Elibri.Hosting
{
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            {
                context.Response.Headers.Append("Content-Security-Policy", "default-src 'self'; connect-src 'self' http://25.49.57.113:3000");
                await next();
            });
...
/*Ќужно разделить на:
1. Elibri.Core.CoreRegistrationExtensions.cs, где в проекте Elibri.Core хранитс€ Services(кроме AuthServices), Repository.
2. Elibri.EF.EFRegistrationExtensions.cs, где в проекте Elibri.EF хранитс€ DTOS, Models.
3. Elibri.Authorization.AuthorizationRegistrationExtensions, где в проекте Elibri.Authorization хран€тс€ DTOS, Services дл€ авторизации.
4. Elibri.Api.ApiRegistrationExtensions, где в проекте Elibri.Api хран€тс€ контроллеры и Web/Routes.*/